...
public class AddReminderActivity extends AppCompatActivity implements
    ...
    private EditText mTitleText,mMedicineText,mExpiryText;
    ...
    private static final String KEY_MEDICINE = "title_medicine";
    private static final String KEY_EXPIRY = "title_expiration";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mExpiryText = (EditText) findViewById(R.id.reminder_expi);
...
mExpiryText.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View view) {
        ...
        android.app.DatePickerDialog datePickerDialog = new android.app.DatePickerDialog(AddReminderActivity.this, new android.app.DatePickerDialog.OnDateSetListener() {
            @Override
        ...
        mMedicineText = (EditText) findViewById(R.id.reminder_med);
        ...
        mMedicineText.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mMed = s.toString().trim();
                mMedicineText.setError(null);
            }
        ...
        mExpiryText.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mExpi = s.toString().trim();
                mExpiryText.setError(null);
            }
        ...
        if (savedInstanceState != null) {
            ...
            String savedMedicine = savedInstanceState.getString(KEY_MEDICINE);
            mMedicineText.setText(savedMedicine);
            mMed = savedMedicine;


            String savedExpiry= savedInstanceState.getString(KEY_EXPIRY);
            mExpiryText.setText(savedExpiry);
            mExpi = savedExpiry;
    ...
    protected void onSaveInstanceState (Bundle outState) {
        ...
        outState.putCharSequence(KEY_MEDICINE, mMedicineText.getText());
        outState.putCharSequence(KEY_EXPIRY, mExpiryText.getText());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.save_reminder:
                ...
                if (mTitleText.getText().toString().length() == 0 || mMedicineText.getText().toString().length() == 0 || mExpiryText.getText().toString().length() == 0 ){
                    mTitleText.setError("Medicine name and medicine intake and medicine expiry cannot be blank!");
                    mMedicineText.setError("cannot be blank!");
                    mExpiryText.setError("cannot be blank!");
...
*/
        ...
        values.put(AlarmReminderContract.AlarmReminderEntry.KEY_MEDICINE, mMed);
        values.put(AlarmReminderContract.AlarmReminderEntry.KEY_EXPIRY, mExpi);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        String[] projection = {
                ...
                AlarmReminderContract.AlarmReminderEntry.KEY_EXPIRY,
